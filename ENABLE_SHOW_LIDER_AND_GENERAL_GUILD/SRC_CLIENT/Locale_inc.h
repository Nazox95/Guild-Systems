...
#define ENABLE_GUILDRENEWAL_SYSTEM	//Extensión de Gremio like Official
	...
	#define GUILD_WAR_COUNTER //Estadisticas de gremio (DracaryS)
	#define ENABLE_GUILD_REQUEST //Ranking Gremial
#endif
///Fin Gremio
//Note: If you have problems add in all files: #include "../UserInterface/Locale_inc.h" 
